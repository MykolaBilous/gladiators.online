...
import type { AttackReach, FighterMotionState } from "../battleSimulatorTypes";
import {
...
import { clamp, clonePoint, getDistance } from "./math";
import {
  clampPoint,
  getSideSign,
  keepPointOnHomeSide,
} from "./movementGeometry";
import { getFighterPosition } from "./motionState";
