...
import type { AttackReach, FighterEnergyState } from "../battleSimulatorTypes";
import {
...
import { isWinded } from "./energy";
import { clamp, isProjectileAttack, isVelesGladiator } from "./math";
