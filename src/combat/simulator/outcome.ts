import type { BattleEvent, BattleFighterRuntime, BattleNetTrap, BattleOutcome, BattleTeamId, BattleActionType } from "../battleTypes";
import type { FighterBrain, TimedBattleAction } from "../battleSimulatorTypes";
import { JAVELIN_ATTACK_CSS_CLASS } from "./constants";
import { clamp, isVelesGladiator } from "./math";
