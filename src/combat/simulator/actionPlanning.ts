import type { BattleActionType, BattleNetTrap } from "../battleTypes";
import type { FighterBrain, PlannedAction } from "../battleSimulatorTypes";
import {
  chooseAttack,
  getJavelinAttack,
  getNetAttack,
...
import { getDistance, isVelesGladiator } from "./math";
import { createMovement, getFighterPosition } from "./movement";
import { estimateImpactDelay } from "./outcome";
