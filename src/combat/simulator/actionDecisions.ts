...
import type { FighterBrain, FighterEnergyState } from "../battleSimulatorTypes";
import {
  getCloseCombatReach,
  getJavelinAttack,
  getNetAttack,
...
import { createEffectiveFighters, getEnergyState, isWinded } from "./energy";
import { clamp, getDistance, isVelesGladiator } from "./math";
import { getFighterPosition, getSteadyStepDistance } from "./movement";
import { randomBetween, randomUnit } from "./random";
import { canCloseToReach, getReachGap, isDistanceInReach } from "./reach";
import { getRuntime } from "./runtime";
import type { BattleActionPlannerContext } from "./actionPlannerTypes";
