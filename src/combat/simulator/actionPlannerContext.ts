import type { BattleDecisionSnapshot, BattleTeamId } from "../battleTypes";
import type { FighterBrain, PlannedAction } from "../battleSimulatorTypes";
import { createDecisionSnapshot, getStartingJavelinCount } from "./ai";
import {
  createEnergyState,
  getEnergyState,
  recoverEnergy,
...
import { createMotionStates } from "./movement";
