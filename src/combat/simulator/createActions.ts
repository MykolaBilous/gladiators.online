...
import { createBattleActionPlannerContext } from "./actionPlannerContext";
import type { BattleSimulationResult } from "./actionPlannerTypes";
import { resolvePendingActions } from "./actionResolver";
import { createEffectiveFighters, getEnergyState } from "./energy";
import { randomBetween, randomUnit } from "./random";
import { getRuntime } from "./runtime";
import { getResolvedDurationMs } from "./outcome";
import {
  chooseTargetId,
