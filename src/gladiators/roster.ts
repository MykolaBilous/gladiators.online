import type { GladiatorClass, GladiatorStatPoints } from "./gladiatorTypes";
import { gladiatorClasses, murmillo, retiarius } from "./gladiatorClasses";
import {
  addStatPoints,
